...
| 옵션                        | 내용                   | 옵션 설정 값 및 예시                                         |
| --------------------------- | ---------------------- | ------------------------------------------------------------ |
| "name"                      | 테마명                 | 대시보드에서 사용할 테마 이름을 명명합니다                   |
| "class": "ghostwhite-theme" | css 파일명             | css 파일명 뒤에 - theme 를 붙여서 사용합니다.<br />aliceblue.css -> aliceblue-theme<br />경로는 css\theme 폴더에 위치합니다. |
| "set_theme"                 | 기본으로 사용할 테마명 | "name" 에 명명한 테마명으로 적용합니다.                      |
